...
export default function Dashboard() {
  ...
  const handleNavigation = (route) => {
    // Si es inventario, navegar a las tabs del inventario
    if (route === "inventory") {
      router.push('/(tabs)/inventory');
    } else if (route === "profile") {
      // Por ahora mantener en la misma pantalla
      console.log('Navegando a perfil');
    } else {
      // Para otros casos, ir a la tab principal
      router.push('/(tabs)');
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.bottomNav, { paddingBottom: insets.bottom }]}>
        ...
        >
          <Svg width={27} height={24} viewBox="0 0 27 24" fill="none">
            <G clipPath="url(#clip7)">
              <Path
                d="M19 17.9923V23.9923H23.2667C25.034 23.9923 26.4667 22.6491 26.4667 20.9923V11.8713C26.4669 11.3518 26.2516 10.8525 25.8661 10.4793L16.8017 1.29224C15.2022 -0.330101 12.5028 -0.42971 10.7723 1.06973C10.6901 1.14098 10.6109 1.21518 10.535 1.29224L1.48645 10.4763C1.08935 10.8511 0.866549 11.358 0.866699 11.8863V20.9923C0.866699 22.6491 2.2994 23.9923 4.0667 23.9923H8.33335V17.9923C8.3533 15.2654 10.7016 13.0387 13.537 12.9746C16.4672 12.9083 18.9777 15.173 19 17.9923Z"
                fill="black"
              />
              <Path
                d="M13.6667 14.9918C11.8994 14.9918 10.4667 16.335 10.4667 17.9918V23.9918H16.8667V17.9918C16.8667 16.335 15.434 14.9918 13.6667 14.9918Z"
                fill="black"
              />
            </G>
          </Svg>
        ...
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => handleNavigation("management")}
        >
          <View style={styles.navIconContainer}>
            <View style={styles.navIconPlaceholder} />
          </View>
          <Text style={styles.navLabel}>Gestión</Text>
        </TouchableOpacity>
        
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => handleNavigation("quality")}
        >
          <View style={styles.navIconContainer}>
            <View style={styles.navIconPlaceholder} />
          </View>
          <Text style={styles.navLabel}>Calidad</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => handleNavigation("deliveries")}
        >
          <View style={styles.navIconContainer}>
            <View style={styles.navIconPlaceholder} />
          </View>
...
const styles = {
  ...
  main: {
    padding: Math.max(16, screenWidth * 0.035),
  ...
  navItem: {
    ...
    flex: 1,
    maxWidth: Math.max(60, screenWidth * 0.15),
  },
  navIconContainer: {
